...
#define	XY_YL5 7
#define	XY_MAX 8
#define NET_YX_SELCT XY_YKC    //选择汇誉/YKC 时，注意下面显示（二维码、IP端口、协议）选择也要选择汇誉

//汇誉协议选择显示
#define show_HY   0    //显示汇誉
#define show_ANC  1    //显示安充/创越
#define HY_Cover_XY show_HY
//YKC协议选择显示
#define show_SY   2    //显示塑云 二维码、IP端口、协议显示
#define show_YKC  3    //显示云快充 二维码、IP端口、协议显示
#define show_DKY  4    //显示达克云 二维码、IP端口、协议显示
#define YKC_Cover_XY show_YKC
...
#define display3or2    3    //3 = 记录显示3位小数点      2=记录显示2位小数点
#define FIRMWARE_VERSION	"AT4408"   //当前显示版本号，只显示5个字节(升级成功后上传的5个字节)
