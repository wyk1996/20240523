...
extern rt_mutex_t rflash_mutex;
extern rt_mutex_t wflash_mutex;
...
uint8_t  APPTransactionrecord(STOP_REASON Stop_reason,_SHOW_NUM Charg_mode,_SHOW_NUM GUNnum,uint32_t CurNum); //存储记录数据
